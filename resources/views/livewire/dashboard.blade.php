<div class="space-y-8">
    <!-- Welcome Section -->
    <div class="bg-linear-to-r from-flowstone-500 to-flowstone-600 rounded-xl p-6 text-white">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold">Welcome to Flowstone</h2>
                <p class="mt-2 text-flowstone-100">Manage and monitor your workflows with ease</p>
            </div>
            <div class="hidden md:block">
                <svg class="w-16 h-16 text-flowstone-200" fill="currentColor" viewBox="0 0 24 24">
