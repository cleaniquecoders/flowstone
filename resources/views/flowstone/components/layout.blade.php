...
<head>
    ...
    {{-- Flowstone UI assets (built via Vite and published to public/vendor/flowstone) --}}
    <link rel="stylesheet" href="{{ rtrim(config('flowstone.ui.asset_url'), '/') }}/flowstone-ui.css" />
</head>
<body class="min-h-screen bg-gray-50">
    ...
    {{-- Vendor externals required by Flowstone UI bundle --}}
    <script src="https://unpkg.com/react@18/umd/react.production.min.js" crossorigin="anonymous"></script>
    <script src="https://unpkg.com/react-dom@18/umd/react-dom.production.min.js" crossorigin="anonymous"></script>

    {{-- Flowstone UI bundle (exposes window.FlowstoneUI.mount) --}}
    <script src="{{ rtrim(config('flowstone.ui.asset_url'), '/') }}/flowstone-ui.js" defer></script>
</body>
</html>
